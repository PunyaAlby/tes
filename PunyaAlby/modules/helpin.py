...
from PunyaAlby import app, Command, filterWhitelist
from PunyaAlby.helpers.misc import paginate_modules
...
@app.on_message(filterWhitelist & filters.command(["helpin"]))
